...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            const { success, message, jwtToken, name, role, adminStatus, error } = result;
            ...
            if (success) {
                ...
                if (result.collegeId) localStorage.setItem('collegeId', result.collegeId);
                ...
                // Handle admin pending/rejected status
                if (adminStatus === 'PENDING') {
                    handleError('⏳ Your admin account is pending approval from the platform admin.');
                } else if (adminStatus === 'REJECTED') {
                    handleError('❌ Your admin account has been rejected.');
                } else {
                    handleError(message);
                }
            }
